...
- Reintegrate the pixel script setting autoConfig to false, to avoid conflicts.

### Fixed

## [2.2.4] - 2026-04-10

- Temporarily removed the pixel script
...
### Changed
- documentation structure and the name **toolbelt** to **VTEX IO CLI.**
## [2.2.1] - 2020-10-27
### Fixed
